		...
		<div className='relative flex flex-col items-center justify-center mx-2 border border-gray-200 rounded-md z-0 pb-[24px] bg-gray-50'>
			...
			<div className='relative flex items-center justify-center h-auto bg-white rounded-md'>
				...
				<form className='z-10 relative w-[400px] h-auto rounded-lg p-[12px] py-[18px] border-2 border-gray-300' action="" onSubmit={ formsubmit }>
					...
					<input onChange={ handlechange } name="date" className='block w-full px-[4px] py-[5px] border-b-2 border-gray-300 my-[10px] mt-0 rounded-sm text-[18px] outline-none bg-transparent text-black' type="date" placeholder="" />
					<label className='text-gray-500' htmlFor="">Name:</label>
					<input onChange={ handlechange } name="name" className='block w-full px-[4px] py-[5px] border-b-2 border-gray-300 my-[10px] mt-0 rounded-sm text-[18px] outline-none bg-transparent text-black' type="text" id="" placeholder='' />
					<label className='text-gray-500' htmlFor="">Address:</label>
					<input onChange={ handlechange } name="address" className=' block w-full px-[4px] py-[5px] border-b-2 border-gray-300 my-[10px] mt-0 rounded-sm text-[18px] outline-none bg-transparent text-black' type="text" placeholder='' />
					<label className='text-gray-500' htmlFor="">Location/City:</label>
					<input onChange={ handlechange } name="city" className='block w-full px-[4px] py-[5px] border-b-2 border-gray-300 my-[10px] mt-0 rounded-sm text-[18px] outline-none bg-transparent text-black' type="text" placeholder='' />
					<label className='text-gray-500' htmlFor="">Contact:</label>
					<input onChange={ handlechange } name="contact" className='mb-[30px] block w-full px-[4px] py-[5px] border-b-2 border-gray-300 my-[10px] mt-0 rounded-sm text-[18px] outline-none bg-transparent text-black' type="tel" placeholder='' />
