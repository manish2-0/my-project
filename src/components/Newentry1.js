...
function Newentry1() {
    ...
    const formsubmit = async (event) => {
        event.preventDefault()
        await axios.post(`http://localhost:80/api/dataentry/`, inputs).then(function (response) {
            ...
            <div className='relative flex items-center justify-center h-auto bg-white rounded-md'>
                ...
                <form className='z-10 w-[800px] relative h-auto rounded-lg p-[12px] py-[18px] border-2 border-gray-300' onSubmit={ formsubmit } >
                    ...
                    <div className='flex justify-end p-2 '>
                        ...
                        <select onChange={ handlechange } name="nature" className="mx-2 px-[4px] w-full py-[3px] border-b-2 border-gray-300 rounded-sm text-[18px] outline-none bg-transparent text-black">
                        ...
                        <select onChange={ handlechange } name="status" className="mx-2 w-full px-[4px] py-[3px] border-b-2 border-gray-300 rounded-sm text-[18px] outline-none bg-transparent text-black">
                    ...
                    <div className='justify-end flex p-2 '>
                        ...
                        <select onChange={ handlechange } name="billstatus" className="mx-2 px-[4px]  py-[3px] border-b-2 border-gray-300 rounded-sm text-[18px] outline-none bg-transparent text-black">
                            <option selected className=''>Choose a option..</option>
                            <option>Pending</option>
                            <option>Done</option>
                        </select>
                    ...
                    <h4 className='text-blue-900 p-2 text-[20px] min-w-fit underline '>Upload Files:</h4>

                    <div className='flex justify-start p-2 '>

                        <label className='text-gray-500 py-[3px] text-[18px] min-w-fit mr-2' htmlFor="">Upload Files:</label>
                        <input onChange={ handlechangefile } name="files1" className='px-[3px] py-[3px] rounded-sm text-[18px] outline-none bg-transparent text-black' type="file" id="" multiple placeholder='' />
