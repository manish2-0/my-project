        ...
        <div className='relative mx-auto md:container '>
            ...
            <Link to="/editclient" state={{ user:user }} className='text-gray-400'>Edit</Link>
                ...
                <div className='flex flex-wrap justify-between text-gray-400'>
                    ...
                    <Link to="/editclient" state={{ user:user }} className='pl-2 text-gray-400'><i class="fa-solid fa-pencil"></i></Link>
                    </div>
                ...
                <div className='flex flex-col items-center justify-between text-fix'>
                    ...
                    <Link className='hover:bg-[#1967b6] w-3/4 px-4 text-center py-2 text-white rounded-md homepagebutton bg-fix mt-2'>Edit Bill</Link>
                    ...
                    <Link className='hover:bg-[#1967b6] w-3/4 px-4 text-center py-2 text-white rounded-md homepagebutton bg-fix mt-2'>Generate Bill</Link>
